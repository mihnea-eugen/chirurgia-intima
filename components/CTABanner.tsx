    ...
    <section className="card-glow rounded-2xl px-8 py-12 lg:px-14 lg:py-16 my-0">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <a
          ...
          className="not-prose inline-flex items-center gap-2 px-5 py-3 rounded-md font-medium text-white bg-[#25D366] hover:bg-[#1DA851] transition-all shadow-md hover:shadow-lg"
