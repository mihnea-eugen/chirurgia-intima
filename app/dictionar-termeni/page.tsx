...
const termeni = [
  ...
  { t: "Acid hialuronic (HA)", d: "Filler dermal reticulat folosit pentru augmentare non-chirurgicală. Reversibil cu hialuronidază." },
  { t: "Fimoză", d: "Imposibilitate de retragere a prepuțului peste gland. Indicație pentru circumcizie sau preputioplastie." },
  { t: "BXO (Lichen scleros)", d: "Boala dermatologică inflamatorie care produce fimoză cicatricială." },
  ...
  { t: "P-Shot / PRP", d: "Injectare plasmă îmbogățită cu trombocite (PRP) pentru regenerare țesut penian." },
  { t: "Kanamicina", d: "Antibiotic interzis pentru injectare subcutanată genitală. Produce granulom și fibroză." },
  { t: "Granulom peniann", d: "Reacție inflamatorie cronică față de corp străin injectat (kanamicina, silicon, vaselină)." },
  ...
  { t: "Hidden penis", d: "Penis ascuns sub piele pubiană — corecție prin liposucție + faloplastie." },
